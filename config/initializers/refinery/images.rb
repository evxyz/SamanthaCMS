Refinery::Images.configure do |config|
  ...
  # Configure image sizes
   config.user_image_sizes = {:small=>"225x225>", :medium=>"550x550>", :large=>"999x999>"}
  ...
  # config.dragonfly_secret = "d12d5969afedbba84c50ac09c3c2813875c0efadbecaac74"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/evx001/_r_/cms_sam/samanthaCMS/public/system/refinery/images"
